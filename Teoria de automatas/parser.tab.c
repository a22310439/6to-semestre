...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_SETUNION = 3,                   /* SETUNION  */
  YYSYMBOL_CLEARSET = 4,                   /* CLEARSET  */
  YYSYMBOL_PRINTSET = 5,                   /* PRINTSET  */
  YYSYMBOL_SHOWSETS = 6,                   /* SHOWSETS  */
  YYSYMBOL_DELETESET = 7,                  /* DELETESET  */
  YYSYMBOL_UNIONSET = 8,                   /* UNIONSET  */
  YYSYMBOL_INTERSECTION = 9,               /* INTERSECTION  */
